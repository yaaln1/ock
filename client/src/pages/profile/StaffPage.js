...
useEffect(() => {
    ...
    return (
        ...
        <div className="row blue-grey lighten-5 z-depth-2 print-div">
            ...
            <h3 className="no-print">Сотрудники</h3>
            <h3 className="invisibleprint print-h"><b>Список сотрудников <br/>КГП "Областной центр крови" УЗАКО на {new Date().toLocaleString()}</b></h3>

            <table className="highlight">
                <thead>
                <tr className="reporttabletext">
                    <th>№</th>
                    <th>ФИО</th>
                    <th>Отдел</th>
                    <th>Должность</th>
                ...
                <tbody className="reporttabletext">
